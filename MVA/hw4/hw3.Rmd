...
# classification
pi1_X <- dmvnorm(new.iris, mean = mu1, sigma = S1) # P(X|Label = Versicolor)
pi2_X <- dmvnorm(new.iris, mean = mu2, sigma = S2) # P(X|Label = Virginica)
...
```{r}
pairs(new.iris, col = ifelse(predicted == 'versicolor', 'red', 'blue')) # predicted
pairs(new.iris, col = ifelse(species == 'versicolor', 'red', 'blue')) # true
```
